...
Route::group(['namespace' => 'App\Http\Controllers'],function()
{
    ...
    Route::controller(ReportController::class)->group(function () {
        Route::get('report/list', 'report')->middleware('auth')->name('report/list'); // list report
        Route::get('report/grid', 'reportGrid')->middleware('auth')->name('report/grid'); // grid report
        Route::get('report/add/page', 'reportAdd')->middleware('auth')->name('report/add/page'); // page report
        ...
        Route::get('report/profile/{id}', 'reportProfile')->middleware('auth'); // profile report
    });
