    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu {{set_active(['report/list','report/grid','report/add/page'])}} {{ (request()->is('report/edit/*')) ? 'active' : '' }} {{ (request()->is('report/profile/*')) ? 'active' : '' }}">
                    <a href="#"><i class="fas fa-clipboard"></i>
                        <span> Reports</span>
                        <span class="menu-arrow"></span>
                    </a>
                    <ul>
                        <li><a href="{{ route('report/list') }}"  class="{{set_active(['report/list','report/grid'])}}">Report List</a></li>
                        @if(request()->is('report/add/*'))
                        <li><a href="{{ route('report/add/page') }}" class="{{set_active(['report/add/page'])}}">Report Add</a></li>
                         @endif
                         @if(request()->is('report/edit/*'))
                         <li><a class="{{ (request()->is('report/edit/*')) ? 'active' : '' }}">Report Edit</a></li>
                         @endif
                         @if(request()->is('report/view/*'))
                         <li><a href=""  class="{{ (request()->is('report/profile/*')) ? 'active' : '' }}">Report View</a></li>
                         @endif
                    </ul>
                </li>
